    ...
    <div className="w-[90%] mx-auto max-w-[700px]">
        ...
        >
            <div className='my-16 flex items-center justify-center flex-col '>
                <img src={image} alt="self_potrait" className='h-[200px] w-[200px] rounded-full' />
            ...
            <ul className='flex flex-col gap-2'>
                <Link className='p-[1rem] bg-[#f3f3f3] cursor-pointer flex items-center justify-between rounded-md' to="/contact">
