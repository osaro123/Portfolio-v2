  ...
  return (
    <div>
        ...
        <div className='py-8 sm:flex flex-col gap-8'>
            <Link to="/contact" className='flex gap-2 items-center text-[#706f6c]'><BsArrowUpRight/>Email</Link>
            <Link to="/links" className='flex gap-2 items-center text-[#706f6c]'><BsArrowUpRight/>Connect with me</Link>
            <Link to={resume} target='blank' className='flex gap-2 items-center text-[#706f6c]'><BsArrowUpRight/>Resume</Link>
        </div>
    </div>
  )
}
